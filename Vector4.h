...
public:
    ...
    {
        return Opengl::Abs(x_ * rhs.x_) + Opengl::Abs(y_ * rhs.y_) + Opengl::Abs(z_ * rhs.z_) + Opengl::Abs(w_ * rhs.w_);
    }
    ...
    Vector4 Abs() const { return Vector4(Opengl::Abs(x_), Opengl::Abs(y_), Opengl::Abs(z_), Opengl::Abs(w_)); }
    ...
    {
        return Opengl::Equals(x_, rhs.x_) && Opengl::Equals(y_, rhs.y_) && Opengl::Equals(z_, rhs.z_) && Opengl::Equals(w_, rhs.w_);
    }

    /// Return whether any component is NaN.
    bool IsNaN() const { return Opengl::IsNaN(x_) || Opengl::IsNaN(y_) || Opengl::IsNaN(z_) || Opengl::IsNaN(w_); }

    /// Return whether any component is Inf.
    bool IsInf() const { return Opengl::IsInf(x_) || Opengl::IsInf(y_) || Opengl::IsInf(z_) || Opengl::IsInf(w_); }
