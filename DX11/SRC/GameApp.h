...
private:
	...
	//列表参数
	 ...
	 Geometry::MeshData<VertexPosNormalColor>makr_meshdata;//加载的三维模型
	 //参考的兴趣点
	 std::vector<std::pair<DirectX::XMFLOAT3, Geometry::MeshData<VertexPosNormalColor>>>mark_poilShperelist;
	 //手动标记的兴趣点
	 std::vector<std::pair<DirectX::XMFLOAT3, Geometry::MeshData<VertexPosNormalColor>>>_mark_poilShperelist;//兴趣点
