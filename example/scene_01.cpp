...
namespace scene {
    ...
    static vec4  sphere_albedo { 1.0f, 1.0f, 0.2f, 1.0f };
    ...
    void Scene01::Init() {
        ...
        PrecomputeIBL("res/texture/HDRI/Field-Path-Fence-Steinbacher-Street-4K.hdr");

        resource_manager.Add(-1, MakeAsset<Mesh>(Primitive::Sphere));
        resource_manager.Add(01, MakeAsset<Shader>("infinite_grid.glsl"));
        resource_manager.Add(02, MakeAsset<Shader>("skybox.glsl"));
        resource_manager.Add(03, MakeAsset<Shader>("light.glsl"));
        resource_manager.Add(04, MakeAsset<Shader>( "pbr01.glsl"));
        resource_manager.Add(05, MakeAsset<Shader>("post_process01.glsl"));
        resource_manager.Add(00, MakeAsset<CShader>("bloom.glsl"));
        resource_manager.Add(10, MakeAsset<CShader>("cull.glsl"));
       ...
       auto  Window = instance->GetWindowSize();
        ...
        AddFBO(Window.first, Window.second);
        AddFBO(Window.first, Window.second);
        AddFBO(Window.first, Window.second);
        AddFBO(Window.first/2, Window.second/2);
        ...
        if (std::string model_path = "res\\model\\runestone\\runestone.fbx"; true) {
    ...
    void Scene01::SetupMaterial(Material& pbr_mat, int mat_id) {
        ...
        if (mat_id == 0) {  // sphere
            ...
            pbr_mat.SetTexture(pbr_t::albedo, MakeAsset<Texture>( "res\\texture\\common\\checkboard.png"));
            ...
            std::string tex_path = "res\\model\\runestone\\";
    ...
    void Scene01::SetupPLBuffers() {
        openglApp* instance = GetOpenglApp();
        auto  Window = instance->GetWindowSize();
        nx = (Window.first  + tile_size - 1) / tile_size;
        ny = (Window.second + tile_size - 1) / tile_size;
