...
namespace scene {
    ...
    void Scene05::Init() {
        ...
        resource_manager.Add(04, MakeAsset<Shader>( "pbr05.glsl"));
        resource_manager.Add(05, MakeAsset<Shader>( "post_process05.glsl"));
        resource_manager.Add(06, MakeAsset<Shader>("shadow05.glsl"));
