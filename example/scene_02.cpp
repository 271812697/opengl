...
namespace scene {
    ...
    void Scene02::Init() {
        ...
        resource_manager.Add(StringToHash("bloom.glsl"), MakeAsset<CShader>("bloom.glsl"));
        resource_manager.Add(StringToHash("infinite_grid.glsl"), MakeAsset<Shader>( "infinite_grid.glsl"));
        resource_manager.Add(StringToHash("skybox.glsl"), MakeAsset<Shader>( "skybox.glsl"));
        resource_manager.Add(StringToHash("light.glsl"), MakeAsset<Shader>( "light.glsl"));
        resource_manager.Add(StringToHash("pbr.glsl"), MakeAsset<Shader>("pbr02.glsl"));
        resource_manager.Add(StringToHash("post_process.glsl"), MakeAsset<Shader>(paths::shader + "post_process02.glsl"));
