...
public:
    ...
    {
        return Opengl::Abs(x_ * rhs.x_) + Opengl::Abs(y_ * rhs.y_) + Opengl::Abs(z_ * rhs.z_);
    }
    ...
    Vector3 Abs() const { return Vector3(Opengl::Abs(x_), Opengl::Abs(y_), Opengl::Abs(z_)); }
    ...
    {
        return Opengl::Equals(x_, rhs.x_) && Opengl::Equals(y_, rhs.y_) && Opengl::Equals(z_, rhs.z_);
    }

    /// Returns the angle between this vector and another vector in degrees.
    float Angle(const Vector3& rhs) const { return Opengl::Acos(DotProduct(rhs) / (Length() * rhs.Length())); }

    /// Return whether any component is NaN.
    bool IsNaN() const { return Opengl::IsNaN(x_) || Opengl::IsNaN(y_) || Opengl::IsNaN(z_); }

    /// Return whether any component is Inf.
    bool IsInf() const { return Opengl::IsInf(x_) || Opengl::IsInf(y_) || Opengl::IsInf(z_); }
