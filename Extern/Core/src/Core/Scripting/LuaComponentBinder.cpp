...
void Core::Scripting::LuaComponentBinder::BindComponent(sol::state & p_luaState)
{
    ...
    p_luaState.new_enum<Core::ECS::Components::CModelRenderer::EFrustumBehaviour>("FrustumBehaviour",
        {
            {"DISABLED",		Core::ECS::Components::CModelRenderer::EFrustumBehaviour::DISABLED},
            {"CULL_MODEL",		Core::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_MODEL},
            {"CULL_MESHES",		Core::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_MESHES},
            {"CULL_CUSTOM",		Core::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_CUSTOM}
        });
	...
	p_luaState.new_enum<Physics::Entities::PhysicalObject::ECollisionDetectionMode>("CollisionDetectionMode",
		{
			{"DISCRETE",		Physics::Entities::PhysicalObject::ECollisionDetectionMode::DISCRETE},
			{"CONTINUOUS",		Physics::Entities::PhysicalObject::ECollisionDetectionMode::CONTINUOUS}
		});
    ...
    p_luaState.new_enum<Rendering::Settings::EProjectionMode>("ProjectionMode",
    {
        {"ORTHOGRAPHIC",	Rendering::Settings::EProjectionMode::ORTHOGRAPHIC},
        {"PERSPECTIVE",		Rendering::Settings::EProjectionMode::PERSPECTIVE}
    });
