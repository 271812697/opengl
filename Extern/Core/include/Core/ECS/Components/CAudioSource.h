...
namespace Core::ECS::Components
{
	...
	*/
	...
	public:
		...
		* @param p_sound
		*/
		void SetSound(Audio::Resources::Sound* p_sound);
		...
		*/
		Audio::Resources::Sound* GetSound() const;
	...
	private:
		Audio::Resources::Sound* m_sound = nullptr;
		Audio::Entities::AudioSource m_audioSource;
