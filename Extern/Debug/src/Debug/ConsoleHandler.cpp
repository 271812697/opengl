...
std::string const Debug::ConsoleHandler::__DEFAULT_HEADER;
std::string const Debug::ConsoleHandler::__INFO_HEADER = "[INFO] ";
std::string const Debug::ConsoleHandler::__WARNING_HEADER = "[WARNING] ";
std::string const Debug::ConsoleHandler::__ERROR_HEADER = "[ERROR] ";

void Debug::ConsoleHandler::Log(const LogData& p_logData)
{
...
std::string Debug::ConsoleHandler::GetLogHeader(ELogLevel p_logLevel)
{
	switch (p_logLevel)
	{
