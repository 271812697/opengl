...
{
	/**
	* The renderer is one of the main classes of Rendering. It is necessary to have one to
	...
	*/
	...
	public:
		...
		* @param p_stencilBuffer
		*/
		void Clear(Rendering::LowRenderer::Camera& p_camera, bool p_colorBuffer = true, bool p_depthBuffer = true, bool p_stencilBuffer = true);
		...
		*/
		std::vector<std::reference_wrapper<Rendering::Resources::Mesh>> GetMeshesInFrustum
		(
