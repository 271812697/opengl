...
Rendering::Core::Renderer::Renderer(Context::Driver& p_driver) : m_driver(p_driver), m_state(0)
{
}

void Rendering::Core::Renderer::SetClearColor(float p_red, float p_green, float p_blue, float p_alpha)
{
	glClearColor(p_red, p_green, p_blue, p_alpha);
}

void Rendering::Core::Renderer::Clear(bool p_colorBuffer, bool p_depthBuffer, bool p_stencilBuffer)
{
	glClear
	(
...
void Rendering::Core::Renderer::Clear(Rendering::LowRenderer::Camera & p_camera, bool p_colorBuffer, bool p_depthBuffer, bool p_stencilBuffer)
{
	...
	const Maths::FVector3& cameraClearColor = p_camera.GetClearColor();
...
void Rendering::Core::Renderer::SetRasterizationLinesWidth(float p_width)
{
	glLineWidth(p_width);
}

void Rendering::Core::Renderer::SetRasterizationMode(Settings::ERasterizationMode p_rasterizationMode)
{
	glPolygonMode(GL_FRONT_AND_BACK, static_cast<GLenum>(p_rasterizationMode));
}

void Rendering::Core::Renderer::SetCapability(Settings::ERenderingCapability p_capability, bool p_value)
{
	(p_value ? glEnable : glDisable)(static_cast<GLenum>(p_capability));
}

bool Rendering::Core::Renderer::GetCapability(Settings::ERenderingCapability p_capability) const
{
	return glIsEnabled(static_cast<GLenum>(p_capability));
}

void Rendering::Core::Renderer::SetStencilAlgorithm(Settings::EComparaisonAlgorithm p_algorithm, int32_t p_reference, uint32_t p_mask)
{
	glStencilFunc(static_cast<GLenum>(p_algorithm), p_reference, p_mask);
}

void Rendering::Core::Renderer::SetDepthAlgorithm(Settings::EComparaisonAlgorithm p_algorithm)
{
	glDepthFunc(static_cast<GLenum>(p_algorithm));
}

void Rendering::Core::Renderer::SetStencilMask(uint32_t p_mask)
{
	glStencilMask(p_mask);
}

void Rendering::Core::Renderer::SetStencilOperations(Settings::EOperation p_stencilFail, Settings::EOperation p_depthFail, Settings::EOperation p_bothPass)
{
	glStencilOp(static_cast<GLenum>(p_stencilFail), static_cast<GLenum>(p_depthFail), static_cast<GLenum>(p_bothPass));
}

void Rendering::Core::Renderer::SetCullFace(Settings::ECullFace p_cullFace)
{
	glCullFace(static_cast<GLenum>(p_cullFace));
}

void Rendering::Core::Renderer::SetDepthWriting(bool p_enable)
{
	glDepthMask(p_enable);
}

void Rendering::Core::Renderer::SetColorWriting(bool p_enableRed, bool p_enableGreen, bool p_enableBlue, bool p_enableAlpha)
{
	glColorMask(p_enableRed, p_enableGreen, p_enableBlue, p_enableAlpha);
}

void Rendering::Core::Renderer::SetColorWriting(bool p_enable)
{
	glColorMask(p_enable, p_enable, p_enable, p_enable);
}

void Rendering::Core::Renderer::SetViewPort(uint32_t x, uint32_t y, uint32_t width, uint32_t height)
{
	glViewport(x, y, width, height);
}

void Rendering::Core::Renderer::ReadPixels(uint32_t x, uint32_t y, uint32_t width, uint32_t height, Settings::EPixelDataFormat format, Settings::EPixelDataType type, void* data)
{
	glReadPixels(x, y, width, height, static_cast<GLenum>(format), static_cast<GLenum>(type), data);
}

bool Rendering::Core::Renderer::GetBool(GLenum p_parameter)
{
	GLboolean result;
...
bool Rendering::Core::Renderer::GetBool(GLenum p_parameter, uint32_t p_index)
{
	GLboolean result;
...
int Rendering::Core::Renderer::GetInt(GLenum p_parameter)
{
	GLint result;
...
int Rendering::Core::Renderer::GetInt(GLenum p_parameter, uint32_t p_index)
{
	GLint result;
...
float Rendering::Core::Renderer::GetFloat(GLenum p_parameter)
{
	GLfloat result;
...
float Rendering::Core::Renderer::GetFloat(GLenum p_parameter, uint32_t p_index)
{
	GLfloat result;
...
double Rendering::Core::Renderer::GetDouble(GLenum p_parameter)
{
	GLdouble result;
...
double Rendering::Core::Renderer::GetDouble(GLenum p_parameter, uint32_t p_index)
{
	GLdouble result;
...
int64_t Rendering::Core::Renderer::GetInt64(GLenum p_parameter)
{
	GLint64 result;
...
int64_t Rendering::Core::Renderer::GetInt64(GLenum p_parameter, uint32_t p_index)
{
	GLint64 result;
...
std::string Rendering::Core::Renderer::GetString(GLenum p_parameter)
{
	const GLubyte* result = glGetString(p_parameter);
	return result ? reinterpret_cast<const char*>(result) : std::string();
}

std::string Rendering::Core::Renderer::GetString(GLenum p_parameter, uint32_t p_index)
{
	const GLubyte* result = glGetStringi(p_parameter, p_index);
	return result ? reinterpret_cast<const char*>(result) : std::string();
}

void Rendering::Core::Renderer::ClearFrameInfo()
{
...
void Rendering::Core::Renderer::Draw(Resources::IMesh& p_mesh, Settings::EPrimitiveMode p_primitiveMode, uint32_t p_instances)
{
	if (p_instances > 0)
	{
...
std::vector<std::reference_wrapper<Rendering::Resources::Mesh>> Rendering::Core::Renderer::GetMeshesInFrustum
(
...
)
{
	...
	{
		std::vector<std::reference_wrapper<Rendering::Resources::Mesh>> result;
...
uint8_t Rendering::Core::Renderer::FetchGLState()
{
	...
	{
	case Rendering::Settings::ECullFace::BACK:			result |= 0b0010'0000; break;
	case Rendering::Settings::ECullFace::FRONT:			result |= 0b0100'0000; break;
	case Rendering::Settings::ECullFace::FRONT_AND_BACK:  result |= 0b0110'0000; break;
	}

	return result;
}

void Rendering::Core::Renderer::ApplyStateMask(uint8_t p_mask)
{
	if (p_mask != m_state)
	{
		using namespace Rendering::Settings;
...
void Rendering::Core::Renderer::SetState(uint8_t p_state)
{
	m_state = p_state;
}

const Rendering::Core::Renderer::FrameInfo& Rendering::Core::Renderer::GetFrameInfo() const
{
	return m_frameInfo;
}
