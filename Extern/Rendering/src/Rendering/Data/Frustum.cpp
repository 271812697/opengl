...
void Rendering::Data::Frustum::CalculateFrustum(const Maths::FMatrix4& p_viewProjection)
{
	auto columnMajorViewProjection = Maths::FMatrix4::Transpose(p_viewProjection);
...
bool Rendering::Data::Frustum::PointInFrustum(float x, float y, float z) const
{
...
bool Rendering::Data::Frustum::SphereInFrustum(float x, float y, float z, float radius) const
{
...
bool Rendering::Data::Frustum::CubeInFrustum(float x, float y, float z, float size) const
{
...
bool Rendering::Data::Frustum::BoundingSphereInFrustum(const Rendering::Geometry::BoundingSphere& p_boundingSphere, const Maths::FTransform& p_transform) const
{
	...
	auto sphereOffset = Maths::FQuaternion::RotatePoint(p_boundingSphere.position, rotation) * maxScale;
...
std::array<float, 4> Rendering::Data::Frustum::GetFarPlane() const
{
