...
UI::Widgets::Layout::TreeNode::TreeNode(const std::string & p_name, bool p_arrowClickToOpen) :
	DataWidget(name),
	name(p_name),
...
void UI::Widgets::Layout::TreeNode::Open()
{
	m_shouldOpen = true;
	m_shouldClose = false;
}

void UI::Widgets::Layout::TreeNode::Close()
{
	m_shouldClose = true;
	m_shouldOpen = false;
}

bool UI::Widgets::Layout::TreeNode::IsOpened() const
{
	return m_opened;
}

void UI::Widgets::Layout::TreeNode::_Draw_Impl()
{
