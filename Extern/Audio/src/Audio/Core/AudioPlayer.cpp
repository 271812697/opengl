...
Audio::Core::AudioPlayer::AudioPlayer(AudioEngine& p_audioEngine) : m_audioEngine(p_audioEngine)
{
}

std::unique_ptr<Audio::Tracking::SoundTracker> Audio::Core::AudioPlayer::PlaySound(const Resources::Sound& p_sound, bool p_autoPlay, bool p_looped, bool p_track)
{
...
std::unique_ptr<Audio::Tracking::SoundTracker> Audio::Core::AudioPlayer::PlaySpatialSound(const Resources::Sound& p_sound, bool p_autoPlay, bool p_looped, const Maths::FVector3& p_position, bool p_track)
{
	std::unique_ptr<Tracking::SoundTracker> result;
