...
{
	/**
	* Main class of Physics, it handles the creation of the physical world. It must be created
	...
	*/
	...
	public:
		...
		*/
		 ...
		 * @param p_end
		 */
		std::optional<Entities::RaycastHit> Raycast(Maths::FVector3 p_origin, Maths::FVector3 p_direction, float p_distance);

		/**
		* Defines the world gravity to apply
		* @param p_gravity
		*/
		void SetGravity(const Maths::FVector3& p_gravity);

		/**
		* Returns the current world gravity
		*/
		Maths::FVector3 GetGravity() const;
	...
	private:
		...
		void Consider(Physics::Entities::PhysicalObject& p_toConsider);
		void Unconsider(Physics::Entities::PhysicalObject& p_toUnconsider);
