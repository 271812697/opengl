...
namespace Physics::Core { class PhysicsEngine; }
...
namespace Physics::Entities
{
	...
	*/
	...
	{
	public:
		friend class Physics::Core::PhysicsEngine;
		...
		* @param p_transform
		*/
		PhysicalObject(Maths::FTransform& p_transform);
		...
		* @param p_force
		*/
		void AddForce(const Maths::FVector3& p_force);

		/**
		* Add an impulse to the physical object
		* @param p_impulse
		*/
		void AddImpulse(const Maths::FVector3& p_impulse);
		...
		*/
		Maths::FVector3 GetLinearVelocity() const;

		/**
		* Returns the angular of the physical object
		*/
		Maths::FVector3 GetAngularVelocity() const;

		/**
		* Returns the linear factor of the physical object
		*/
		Maths::FVector3 GetLinearFactor()	const;

		/**
		* Returns the angular factor of the physical object
		*/
		Maths::FVector3 GetAngularFactor() const;
		...
		*/
		void SetLinearVelocity(const Maths::FVector3& p_linearVelocity);

		/**
		* Defines a new angular velocity for the physical object
		* @param p_angularVelocity
		*/
		void SetAngularVelocity(const Maths::FVector3& p_angularVelocity);

		/**
		* Defines a new linear factor for the physical object
		* @param p_linearFactor
		*/
		void SetLinearFactor(const Maths::FVector3& p_linearFactor);

		/**
		* Defines a new angular factor for the physical object
		* @param p_angularFactor
		*/
		void SetAngularFactor(const Maths::FVector3& p_angularFactor);
	...
	protected:
		...
		void RecreateBody();
		void ApplyInertia();
		virtual void SetLocalScaling(const Maths::FVector3& p_scaling) = 0;
		void Consider();
		void Unconsider();
	...
	public:
		...
		::Tools::Eventing::Event<PhysicalObject&>			CollisionStartEvent;
		::Tools::Eventing::Event<PhysicalObject&>			CollisionStayEvent;
		::Tools::Eventing::Event<PhysicalObject&>			CollisionStopEvent;

		::Tools::Eventing::Event<PhysicalObject&>			TriggerStartEvent;
		::Tools::Eventing::Event<PhysicalObject&>			TriggerStayEvent;
		::Tools::Eventing::Event<PhysicalObject&>			TriggerStopEvent;
	...
	private:
		...
		/* Other */
		std::any m_userData;
		Maths::FVector3 m_previousScale = { 0.0f, 0.0f, 0.0f };
		static ::Tools::Eventing::Event<PhysicalObject&>	CreatedEvent;
		static ::Tools::Eventing::Event<PhysicalObject&>	DestroyedEvent;
		static ::Tools::Eventing::Event<btRigidBody&>		ConsiderEvent;
		static ::Tools::Eventing::Event<btRigidBody&>		UnconsiderEvent;
