...
bool											Analytics::Profiling::Profiler::__ENABLED;
std::mutex										Analytics::Profiling::Profiler::__SAVE_MUTEX;
std::unordered_map<std::string, double>			Analytics::Profiling::Profiler::__ELPASED_HISTORY;
std::unordered_map<std::string, uint64_t>		Analytics::Profiling::Profiler::__CALLS_COUNTER;
std::vector<std::thread::id>					Analytics::Profiling::Profiler::__WORKING_THREADS;
uint32_t										Analytics::Profiling::Profiler::__ELAPSED_FRAMES;

Analytics::Profiling::Profiler::Profiler()
{
	m_lastTime = std::chrono::high_resolution_clock::now();
	__ENABLED = false;
}

Analytics::Profiling::ProfilerReport Analytics::Profiling::Profiler::GenerateReport()
{
...
void Analytics::Profiling::Profiler::ClearHistory()
{
...
void Analytics::Profiling::Profiler::Update(float p_deltaTime)
{
	if (IsEnabled())
	{
		++__ELAPSED_FRAMES;
...
void Analytics::Profiling::Profiler::Save(Analytics::Profiling::ProfilerSpy& p_spy)
{
	__SAVE_MUTEX.lock();
...
bool Analytics::Profiling::Profiler::IsEnabled()
{
	return __ENABLED;
}

void Analytics::Profiling::Profiler::ToggleEnable()
{
	__ENABLED = !__ENABLED;
}

void Analytics::Profiling::Profiler::Enable()
{
	__ENABLED = true;
}

void Analytics::Profiling::Profiler::Disable()
{
	__ENABLED = false;
}