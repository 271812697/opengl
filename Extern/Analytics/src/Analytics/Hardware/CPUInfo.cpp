...
float Analytics::Hardware::CPUInfo::CalculateCPULoad()
{
...
float Analytics::Hardware::CPUInfo::CalculateCPULoad(uint64_t p_idleTicks, uint64_t p_totalTicks)
{
...
uint64_t Analytics::Hardware::CPUInfo::FileTimeToInt64(const FILETIME& ft)
{
