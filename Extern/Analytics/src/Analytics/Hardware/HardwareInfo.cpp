...
#include "Analytics/Hardware/HardwareInfo.h"

Analytics::Hardware::HardwareInfo::HardwareInfo(double p_timeInterval) :
...
Analytics::Hardware::HardwareReport Analytics::Hardware::HardwareInfo::GenerateReport()
{
...
void Analytics::Hardware::HardwareInfo::Tick()
{
...
void Analytics::Hardware::HardwareInfo::Update()
{
