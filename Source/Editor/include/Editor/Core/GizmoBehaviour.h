...
namespace Editor::Core
{
	...
	public:
		...
		* @param p_viewSize
		*/
		void ApplyOperation(const Maths::FMatrix4& p_viewMatrix, const Maths::FMatrix4& p_projectionMatrix, const Maths::FVector2& p_viewSize);
	...
	private:
		...
		* @param p_viewSize
		*/
		void ApplyTranslation(const Maths::FMatrix4& p_viewMatrix, const Maths::FMatrix4& p_projectionMatrix, const Maths::FVector2& p_viewSize) const;
